...
/**
 * Hero — Split-color panel layout.
 * - Left: deep tomato-red sidebar with all text and a postcode form
 * - Right: full-bleed cinematic produce photo (the LCP image)
 *
 * Pure CSS animations only. No framer-motion on the LCP path.
 * LCP h1 has no animation-delay; .lcp-fade starts at opacity: 0.01.
 */
const Hero = () => {
  return (
    <section
    ...
    >
      <div className="grid min-h-[100svh] grid-cols-1 lg:grid-cols-[minmax(0,520px)_1fr]">
        ...
        <div
          className="relative z-10 flex flex-col justify-between bg-[hsl(8_72%_42%)] px-6 pb-10 pt-24 text-[hsl(38_45%_96%)] sm:px-10 lg:min-h-[100svh] lg:px-14 lg:pt-32"
        >
          ...
          <div className="mt-14 lg:mt-0">
            {/* h1 — THE LCP element. Sans serif, all caps, ultra-tight. */}
            <h1 className="lcp-fade font-body text-[clamp(3rem,11vw,7.5rem)] font-bold uppercase leading-[0.86] tracking-[-0.04em] text-[hsl(38_45%_96%)]">
              <span className="block">Real food.</span>
              <span className="block text-[hsl(38_90%_72%)]">Real fast.</span>
              <span className="block">Real cheap.</span>
            </h1>
          ...
          >
            ...
            <div className="flex items-stretch gap-2 border-b-2 border-[hsl(38_45%_96%)]/35 pb-2 transition-colors focus-within:border-[hsl(38_45%_96%)]">
              ...
              <button
                type="submit"
                className="group inline-flex shrink-0 items-center gap-2 bg-[hsl(38_45%_96%)] px-5 py-2.5 text-xs font-bold uppercase tracking-[0.18em] text-[hsl(8_72%_42%)] transition-[background-color,color,transform] duration-150 hover:bg-[hsl(150_35%_18%)] hover:text-[hsl(38_45%_96%)] active:scale-[0.97]"
